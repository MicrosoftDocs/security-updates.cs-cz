...
ms:contentKeyID: 18126699
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc708476(v=WS.10)'
---
...
<td style="border:1px solid black;"><p>Uninstall the product. Also uninstalls the Interní databáze systému Windows instance if it is installed.</p></td>
</tr>  
<tr class="odd">
...
<td style="border:1px solid black;"><p>Path to Interní databáze systému Windows data directory.</p></td>
</tr>  
<tr class="even">
