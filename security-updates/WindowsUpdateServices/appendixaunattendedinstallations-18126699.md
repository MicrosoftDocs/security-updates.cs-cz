...
<td style="border:1px solid black;">Uninstall the product. Also uninstalls the Interní databáze systému Windows instance if it is installed.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Path to Interní databáze systému Windows data directory.</td>
</tr>
<tr class="even">
