...
ms:contentKeyID: 18126561
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc708439(v=WS.10)'
---
...
-   **MSSQLSERVER** (if you are using Interní databáze systému Windows, or if you are using SQL Server and are using the default instance name for the instance name).
