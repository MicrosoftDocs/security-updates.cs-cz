...
ms:contentKeyID: 18126660
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc708563(v=WS.10)'
---
...
| ![](images/Cc708563.Important(WS.10).gif)Důležité informace |
|------------------------------------------------------------------------------------------|
...
| ![](images/Cc708563.note(WS.10).gif)Poznámka                                                                                                                                                                                                                                                                                                                                               |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
