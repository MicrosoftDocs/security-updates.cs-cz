...
ms:contentKeyID: 18126474
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720475(v=WS.10)'
---
...
| ![](images/Cc720475.note(WS.10).gif)Poznámka                       |
|-------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720475.Important(WS.10).gif)Důležité informace |
|------------------------------------------------------------------------------------------|
