...
ms:contentKeyID: 18126677
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc708592(v=WS.10)'
---
...
| ![](images/Cc708592.note(WS.10).gif)Poznámka                                                                                                                                                                                                                                                                                                                  |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
If you are using Interní databáze systému Windows as the WSUS database, use the following string in place of *SqlServerName* in the above command:
