...
ms:contentKeyID: 18126453
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720538(v=WS.10)'
---
...
| ![](images/Cc720538.Important(WS.10).gif)Důležité informace                                                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720538.note(WS.10).gif)Poznámka                                                                                                                                      |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
