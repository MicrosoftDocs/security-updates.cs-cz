...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Dd939791.note(WS.10).gif" />Poznámka</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
The WSUS Operations Guide, available at [http://go.microsoft.com/fwlink/?LinkId=139838](http://go.microsoft.com/fwlink/?linkid=139838), includes other types of migration documentation, such as migrating from Interní databáze systému Windows to Microsoft SQL Server.
