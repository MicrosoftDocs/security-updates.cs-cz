...
ms:contentKeyID: 18126703
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc708610(v=WS.10)'
---
...
| ![](images/Cc708610.Important(WS.10).gif)Důležité informace                                                                                                       |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Uninstalling Interní databáze systému Windows is not recommended, because it may affect other applications that may be using the same database instance (such as Windows SharePoint Services). |
