...
ms:contentKeyID: 18126504
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720511(v=WS.10)'
---
...
| ![](images/Cc720511.note(WS.10).gif)Poznámka                                                                                 |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720511.Important(WS.10).gif)Důležité informace                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
