...
ms:contentKeyID: 18126440
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720523(v=WS.10)'
---
...
| ![](images/Cc720523.Important(WS.10).gif)Důležité informace                                                                                                               |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720523.note(WS.10).gif)Poznámka                                                                             |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|
