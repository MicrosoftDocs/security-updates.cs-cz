...
ms:contentKeyID: 21741159
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Dd939864(v=WS.10)'
---
...
For information about how to manually remove Network Service or ASP.NET accounts from a computer running SQL Server 2005 or Interní databáze systému Windows, see SQL Server product documentation. You can download product documentation for SQL Server at [SQL Server Books Online](http://go.microsoft.com/fwlink/?linkid=81092) (http://go.microsoft.com/fwlink/?LinkId=81092).
