...
ms:contentKeyID: 18126457
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720542(v=WS.10)'
---
...
| ![](images/Cc720542.note(WS.10).gif)Poznámka     |
|-------------------------------------------------------------------------------|
...
The [Windows Server Update Services 3.0 Operations Guide](http://go.microsoft.com/fwlink/?linkid=81072) (http://go.microsoft.com/fwlink/?LinkId=81072) includes other types of migration documentation, such as migrating from Interní databáze systému Windows to Microsoft SQL Server.
