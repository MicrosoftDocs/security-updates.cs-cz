...
ms:contentKeyID: 18126527
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720539(v=WS.10)'
---
...
| ![](images/Cc720539.note(WS.10).gif)Poznámka                                                                     |
|-----------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720539.Important(WS.10).gif)Důležité informace                                                                                                                                                                                                                                                             |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
