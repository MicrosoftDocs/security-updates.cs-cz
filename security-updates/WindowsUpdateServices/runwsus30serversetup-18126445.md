...
ms:contentKeyID: 18126445
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720440(v=WS.10)'
---
...
| ![](images/Cc720440.Important(WS.10).gif)Důležité informace                                                                                                                                                                                                             |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720440.note(WS.10).gif)Poznámka                                                                                                                                   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
