...
ms:contentKeyID: 18126560
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc708533(v=WS.10)'
---
...
| ![](images/Cc708533.note(WS.10).gif)Poznámka               |
|-----------------------------------------------------------------------------------------|
| None of the servers taking part in the cluster should be a front-end domain controller. |

| ![](images/Cc708533.Important(WS.10).gif)Důležité informace |
|------------------------------------------------------------------------------------------|
