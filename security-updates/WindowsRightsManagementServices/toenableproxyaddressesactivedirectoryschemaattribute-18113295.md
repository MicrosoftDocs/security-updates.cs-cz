...
ms:contentKeyID: 18113295
ms:mtpsurl: 'https://technet.microsoft.com/cs-cz/library/Cc720282(v=WS.10)'
---
...
| ![](images/Cc720282.Important(WS.10).gif)Důležité informace                                                     |
|----------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720282.note(WS.10).gif)Poznámka                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
2.  Insert the Windows Server 2003 product CD and navigate to Support\\Tools.
    ...
    | ![](images/Cc720282.Caution(WS.10).gif)Upozornění                                                            |
    |-------------------------------------------------------------------------------------------------------------------------------------------|
