...
#### Možná zástupná řešení chyby zabezpečení aplikace Word související s použitím chybně formátovaného kresleného objektu - CVE-2007-0209:
...
#### Chyba zabezpečení aplikace Word související s použitím chybně formátované funkce - CVE-2007-0515:
...
| Název souboru | Verze       | Datum          | Čas   | Velikost   |  
|---------------|-------------|----------------|-------|------------|  
| Winword.exe   | 11.0.8125.0 | 23. ledna 2007 | 23:03 | 12 263 776 |
  
Word Viewer 2003:
  
| Název souboru | Verze       | Datum          | Čas   | Velikost  |  
|---------------|-------------|----------------|-------|-----------|  
| Wordview.exe  | 11.0.8125.0 | 23. ledna 2007 | 23:03 | 6 963 552 |
...
-   Shih-hao Wengu ze společnosti [Information and Communication Security Technology Center](http://www.icst.org.tw/) za oznámení chyby zabezpečení aplikace Word související s chybně formátovaným řetězcem (CVE-2006-5994).  
-   Shih-hao Wengu ze společnosti [Information and Communication Security Technology Center](http://www.icst.org.tw/) za oznámení chyby zabezpečení aplikace Word související s použitím chybně formátovaných datových struktur (CVE-2006-6456).  
-   Společnosti [USAA](https://www.usaa.com/) za oznámení chyby zabezpečení aplikace Word související s makry - CVE-2007-0208.
