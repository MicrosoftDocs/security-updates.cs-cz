---
TOCTitle: 'MS08-002'
Title: 'Microsoft Security Bulletin MS08-002 - Kritické'
ms:assetid: 'ms08-002'
ms:contentKeyID: 61223753
ms:mtpsurl: 'https://technet.microsoft.com/cs-CZ/library/ms08-002(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS08-002 - Kritické
===============================================

Chyba zabezpečení služby LSASS umožňuje místní zvýšení úrovně oprávnění (943485)
--------------------------------------------------------------------------------
...
Tato důležitá aktualizace řeší chybu zabezpečení služby LSASS (Microsoft Windows Local Security Authority Subsystem Service), která byla oznámena soukromou osobou. Tato chyba zabezpečení by mohla útočníkovi umožnit spuštění libovolného kódu se zvýšenými oprávněními. Útočník, který by tuto chybu zabezpečení zneužil, by mohl získat úplnou kontrolu nad postiženým systémem. Útočník by tak mohl instalovat programy, zobrazovat, měnit či odstraňovat data nebo vytvářet nové účty s úplnými uživatelskými právy.

Jde o důležitou aktualizaci zabezpečení pro všechna podporovaná vydání systému Windows 2000, Windows XP a Windows Server 2003. Další informace získáte v podčásti **Software obsahující tuto chybu a Software neobsahující tuto chybu** tohoto oddílu.

Tato aktualizace zabezpečení odstraňuje chybu zabezpečení ověřením platnosti parametrů předávaných do rozhraní API služby LSASS. Další informace o této chybě zabezpečení získáte v podčásti Nejčastější dotazy pro konkrétní položku chyby v části **Informace o chybách zabezpečení**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|---------------------------|---------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=7956632e-17d9-4876-8340-84fe3e43e5cc)                                                                               | Zvýšení úrovně oprávnění v místním systému | Vysoký                    | Žádný                                 |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6a4cf182-8e36-490e-aefe-edb7b3a0df9c)                                                                                           | Zvýšení úrovně oprávnění v místním systému | Vysoký                    | Žádný                                 |
| [Windows XP Professional x64 Edition a Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=51fc657b-2b4a-4725-a744-d279e027c4a5)                            | Zvýšení úrovně oprávnění v místním systému | Vysoký                    | Žádný                                 |
| [Windows Server 2003 Service Pack 1 a Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=12397b47-b18f-4d4d-b8d7-adec8ff310d5)                                             | Zvýšení úrovně oprávnění v místním systému | Vysoký                    | Žádný                                 |
| [Windows Server 2003 x64 Edition a Windows 2003 Server x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f19fd790-a4e6-4a8a-8077-d1bbfe37ecca)                                    | Zvýšení úrovně oprávnění v místním systému | Vysoký                    | Žádný                                 |
| [Windows Server 2003 SP1 pro systémy s procesorem Itanium a Windows Server 2003 SP2 pro systémy s procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0382a195-aa3d-409b-8a79-9fe61588d8a9) | Zvýšení úrovně oprávnění v místním systému | Vysoký                    | Žádný                                 |
...
<th>Chyba zabezpečení související s obejitím služby LSASS - CVE-2007-5352</th>
...
Zvýšení úrovně oprávnění v místním systému</td>
...
Chyba zabezpečení související s obejitím služby LSASS - CVE-2007-5352  
---------------------------------------------------------------------
  
<span></span>
Ve službě LSASS (Microsoft Windows Local Security Authority Subsystem Service) existuje chyba zabezpečení umožňující zvýšení úrovně oprávnění způsobená nesprávným zpracováním požadavků na místní volání procedur (LPC). Tato chyba zabezpečení by mohla útočníkovi umožnit spuštění vzdáleného kódu se zvýšenými oprávněními. Útočník, který by tuto chybu zabezpečení zneužil, by mohl získat úplnou kontrolu nad postiženým systémem. Útočník by tak mohl instalovat programy, zobrazovat, měnit či odstraňovat data nebo vytvářet nové účty s úplnými uživatelskými právy.
  
Tuto chybu zabezpečení lze zobrazit jako standardní položku v seznamu známých chyb zabezpečení a ohrožení pod číslem [CVE-2007-5352](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5352).
  
#### Skutečnosti snižující závažnost rizika chyby zabezpečení týkající se obejití služby LSASS - CVE-2007-5352
...
#### Možná zástupná řešení chyby zabezpečení týkající se obejití služby LSASS - CVE-2007-5352
...
#### Nejčastější dotazy k chybě zabezpečení týkající se obejití služby LSASS - CVE-2007-5352
  
**Jaký je rozsah této chyby zabezpečení?**  
Ve službě LSASS (Local Security Authority Subsystem Service) existuje chyba zabezpečení umožňující zvýšení oprávnění. Útočník, který by tuto chybu zabezpečení úspěšně zneužil, by mohl spustit kód se zvýšenými oprávněními. Útočník by pak mohl převzít úplnou kontrolu nad postiženým systémem.
  
**Co tuto chybu zabezpečení způsobuje?**  
Proces služby LSASS nezpracovává správně speciálně vytvořené požadavky LPC. Pokud proces služby LSASS přijme speciálně vytvořený požadavek LCP, může útočník spustit kód s oprávněními místního systému.
  
**Co je LSASS?**  
Služba LSASS (Local Security Authority Subsystem Service) poskytuje rozhraní pro správu místního zabezpečení, ověřování v doméně a procesy služby Active Directory. Zajišťuje zpracování ověřování pro klienta i server. Služba LSASS zároveň obsahuje funkce poskytující podporu nástrojů služby Active Directory.
...
Tato aktualizace odstraňuje uvedenou chybu zabezpečení ověřováním platnosti parametrů předávaných do rozhraní API služby LSASS a zabraňuje tak přístupu na neplatné adresy.
...
| Windows Server 2003 x64 Edition a Windows 2003 Server x64 Edition Service Pack 2                                    | Ne      | Ano      | Ano       |  
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4:<br />
Použijte ovládací panel Přidat nebo odebrat programy nebo nástroj Spuninst.exe umístěný ve složce %Windir%\$NTUninstallKB943485$\Spuninst.</td>
</tr>
<tr class="odd">
...
|---------------|---------------|-----------------|-------|-----------|
| lsasrv.dll    | 5.0.2195.7147 | 15. října 2007  | 23:04 | 513 808   |
...
<br />
Pro všechna podporovaná vydání systému Windows XP s procesorem x64:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informace o odinstalaci</strong></td>
<td style="border:1px solid black;">Použijte ovládací panel Přidat nebo odebrat programy nebo nástroj Spuninst.exe umístěný ve složce %Windir%\$NTUninstallKB943485$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informace o souborech</strong></td>
<td style="border:1px solid black;">Informace o celém seznamu souborů získáte v následující podčásti <strong>Informace o souborech</strong>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Ověření klíče registru</strong></td>
...
<p>Pro všechna podporovaná vydání systému Windows XP s procesorem x64:</p>
...
|---------------|---------------|-------------------|-------|----------|--------|
| lsasrv.dll    | 5.1.2600.3249 | 6. listopadu 2007 | 19:56 | 721 920  | SP2GDR |
| lsasrv.dll    | 5.1.2600.3249 | 6. listopadu 2007 | 20:20 | 727 040  | SP2QFE |

Pro všechna podporovaná vydání systému Windows XP s procesorem x64:

| Název souboru | Verze         | Datum             | Čas  | Velikost  | Procesor | Složka |
|---------------|---------------|-------------------|------|-----------|----------|--------|
| lsasrv.dll    | 5.2.3790.3041 | 9. listopadu 2007 | 7:16 | 1 567 744 | x64      | SP1GDR |
| lsasrv.dll    | 5.2.3790.3041 | 9. listopadu 2007 | 7:31 | 1 566 720 | x64      | SP1QFE |
| lsasrv.dll    | 5.2.3790.4186 | 9. listopadu 2007 | 7:12 | 1 566 208 | x64      | SP2GDR |
| lsasrv.dll    | 5.2.3790.4186 | 9. listopadu 2007 | 7:19 | 1 567 232 | x64      | SP2QFE |
...
<br />
Všechna podporovaná vydání s procesorem Itanium systému Windows Server 2003:<br />
...
| Název souboru | Verze         | Datum             | Čas  | Velikost | Složka |
|---------------|---------------|-------------------|------|----------|--------|
| lsasrv.dll    | 5.2.3790.3041 | 8. listopadu 2007 | 6:18 | 822 784  | SP1GDR |
| lsasrv.dll    | 5.2.3790.3041 | 8. listopadu 2007 | 5:29 | 822 784  | SP1QFE |
| lsasrv.dll    | 5.2.3790.4186 | 8. listopadu 2007 | 7:45 | 815 616  | SP2GDR |
| lsasrv.dll    | 5.2.3790.4186 | 8. listopadu 2007 | 7:39 | 815 616  | SP2QFE |

Všechna podporovaná vydání s procesorem Itanium systému Windows Server 2003:

| Název souboru | Verze         | Datum             | Čas  | Velikost  | Procesor | Složka |
|---------------|---------------|-------------------|------|-----------|----------|--------|
| lsasrv.dll    | 5.2.3790.3041 | 9. listopadu 2007 | 7:02 | 2 163 200 | IA-64    | SP1GDR |
| lsasrv.dll    | 5.2.3790.3041 | 9. listopadu 2007 | 7:07 | 2 162 688 | IA-64    | SP1QFE |
| lsasrv.dll    | 5.2.3790.4186 | 9. listopadu 2007 | 7:07 | 2 163 712 | IA-64    | SP2GDR |
| lsasrv.dll    | 5.2.3790.4186 | 9. listopadu 2007 | 7:02 | 2 164 736 | IA-64    | SP2QFE |
...
-   Thomasu Garnierovi ze společnosti [SkyRecon](http://www.skyrecon.com/) za oznámení chyby zabezpečení týkající se obejití služby LSASS (CVE-2007-5352).
