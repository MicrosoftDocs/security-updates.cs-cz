...
<th style="border:1px solid black;" >Chyba zabezpečení dekodéru MJPEG - CVE-2008-0011</th>
<th style="border:1px solid black;" >Chyba zabezpečení analýzy souborů ve formátu SAMI - CVE-2008-1444</th>
...
-   **Změna seznamu řízení přístupu pro soubor quartz.dll**
    ...
    `Takeown.exe /f %WINDIR%\SYSTEM32\QUARTZ.DLLI`  
    `cacls.exe %WINDIR%\SYSTEM32\QUARTZ.DLL /save %TEMP%\QUARTZ_ACL.TXT`  
    `Icacls.exe %WINDIR%\SYSTEM32\QUARTZ.DLL /deny everyone:(F)`
