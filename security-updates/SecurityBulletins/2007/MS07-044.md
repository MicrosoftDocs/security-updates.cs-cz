...
<th style="border:1px solid black;" >Chyba zabezpečení týkající se poškození paměti pracovního prostoru - CVE-2007-3890</th>
<th style="border:1px solid black;" >Celkový stupeň závažnosti</th>
</tr>
</thead>
<tbody>
...
|---------------|------------|-------------------|------|-----------|  
| Excel.exe     | 9.0.0.8964 | 24. července 2007 | 6:54 | 7 233 581 |
...
| Název souboru | Verze       | Datum             | Čas   | Velikost  |  
|---------------|-------------|-------------------|-------|-----------|  
| Excel.exe     | 10.0.6834.0 | 24. července 2007 | 15:56 | 9 360 728 |
...
| Název souboru | Verze       | Datum             | Čas   | Velikost   |  
|---------------|-------------|-------------------|-------|------------|  
| Excel.exe     | 11.0.8146.0 | 23. července 2007 | 08:02 | 10 290 008 |
  
Všechna vydání programu Excel Viewer 2003:
  
| Název souboru | Verze       | Datum             | Čas   | Velikost  |  
|---------------|-------------|-------------------|-------|-----------|  
| Xlview.exe    | 11.0.8146.0 | 23. července 2007 | 08:00 | 5 242 208 |
